                ...
                <div className='p-4'>
                  {chapter.chapterContent.map((lecture, lectureIndex) => (
                    <div key={lectureIndex} className='flex justify-between items-center mb-2'>
                      <span className='font-semibold'>{lectureIndex + 1} {lecture.lectureTitle} - {lecture.lectureDuration} mins - <a href={lecture.lectureUrl} target='_blank' rel="noreferrer" className='text-blue-500'>Link</a> - {lecture.isPreviewFree ? 'Free Preview' : 'Paid'}</span>
            ...
            <div className='bg-white text-gray-700 p-4 rounded relative w-full max-w-80'>
              {
                currentChapterId ? (
                  ...
                  <>
                    ...
                    <div className='mb-4'>
                      <p>Chapter Title</p>
                      <input type="text" value={chapterTitle} onChange={(e) => setChapterTitle(e.target.value)} className='mt-1 block w-full border rounded py-1 px-2' />
                    </div>
                    <button className='w-full bg-blue-400 text-white px-4 py-2 rounded' type='button' onClick={addChapter}>Add</button>
                  </>
                )
              }
